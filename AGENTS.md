...
- Per-bot skills live on that computer (`skills/<name>/SKILL.md`). The teammate writes, edits, and deletes them. Think `getSkills()` reads the folder. Do not add a `skills` table or a marketplace in v1.
