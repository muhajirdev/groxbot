...
- **Right:** computer icon → **Starting desktop** / `{Bot}'s screen` + **Routines** (Think schedules on that bot: `every weekday at 09:00`). Gear → Bot settings (name, title, description, notify). Collapse hides the pane.
