...
const variants = {
  solid:
    "border-0 bg-ink text-on-ink rounded-pill px-4 py-2.5 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:opacity-50 disabled:cursor-not-allowed",
  ghost:
  ...
  icon: "grid size-7 place-items-center border-0 rounded-lg bg-transparent text-muted cursor-pointer outline-none hover:bg-hover data-[on]:bg-selected data-[on]:text-ink focus-visible:ring-2 focus-visible:ring-accent disabled:opacity-50 disabled:cursor-not-allowed",
