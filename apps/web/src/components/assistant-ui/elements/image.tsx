...
function ImageZoom({ src, alt = "Image preview", children }: ImageZoomProps) {
  ...
  return (
    <>
      ...
      >
        <Dialog.Portal>
          <Dialog.Backdrop className="modal-backdrop fixed inset-0 z-50 bg-black/55" />
          <Dialog.Popup className="modal-popup fixed top-1/2 left-1/2 z-50 max-h-[90vh] max-w-[90vw] border-0 bg-transparent p-0 shadow-none outline-none">
            <img
